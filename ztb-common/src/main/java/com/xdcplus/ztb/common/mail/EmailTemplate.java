package com.xdcplus.ztb.common.mail;
...
public class EmailTemplate {
    ...
    public String sendText(String subject, String message,
        ...
        Assert.notNull(toEmail, ResponseEnum.THE_RECEIVER_CANNOT_BE_EMPTY.getMessage());
        Assert.notNull(toEmail.getMail(), ResponseEnum.THE_RECEIVER_CANNOT_BE_EMPTY.getMessage());
    ...
    public String sendFile(String subject, String message,
        ...
        Assert.isTrue(EmailUtil.checkFileExists(attachment.getPath()), ResponseEnum.ATTACHMENT_DOES_NOT_EXIST.getMessage());
    ...
    public String sendFile(String subject, String message,
        ...
        Assert.isTrue(EmailUtil.checkFileExists(attachment), ResponseEnum.ATTACHMENT_DOES_NOT_EXIST.getMessage());
    ...
    public String sendHtml(String subject, String html, EmailTo toEmail) throws MailException {
        ...
        Assert.notBlank(html, ResponseEnum.THE_MESSAGE_CANNOT_BE_EMPTY.getMessage());
        Assert.notNull(toEmail, ResponseEnum.THE_RECEIVER_CANNOT_BE_EMPTY.getMessage());
        Assert.notNull(toEmail.getMail(), ResponseEnum.THE_RECEIVER_CANNOT_BE_EMPTY.getMessage());
    ...
    public String sendHtml(String subject, String html,
        ...
        try {
            ...
            email.setTextMsg(ResponseEnum.YOUR_EMAIL_CLIENT_DOES_NOT_SUPPORT_HTML_MESSAGES.getMessage());
    ...
    private void register(Email email, String subject, String message,
        ...
        Assert.notBlank(subject, ResponseEnum.THE_TOPIC_CANNOT_BE_EMPTY.getMessage());
        Assert.notBlank(message, ResponseEnum.THE_MESSAGE_CANNOT_BE_EMPTY.getMessage());
