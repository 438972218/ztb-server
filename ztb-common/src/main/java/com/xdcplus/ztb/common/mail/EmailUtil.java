...
public class EmailUtil {
    ...
    protected static void addTo(Email email, List<EmailTo> toEmails) throws EmailException {
        ...
        Assert.notEmpty(toEmails, ResponseEnum.THE_RECEIVER_CANNOT_BE_EMPTY.getMessage());
        ...
        Assert.isFalse(index == 0, ResponseEnum.THE_RECEIVER_CANNOT_BE_EMPTY.getMessage());
