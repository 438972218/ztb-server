package com.xdcplus.permission.captcha.base;
...
public abstract class Captcha extends Randoms {
    ...
    public void setFont(int font, int style, float size) throws IOException, FontFormatException {
        this.font = Font.createFont(Font.TRUETYPE_FONT, getClass().getResourceAsStream("/static/font/" + FONT_NAMES[font])).deriveFont(style, size);
    }
