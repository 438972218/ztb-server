...
import com.xdcplus.permission.service.SysEmployeeService;
...
public class SysEmployeeController extends AbstractController {
    ...
    @ApiOperation("查询未绑/未绑用户的员工信息")
    @PostMapping(value = "getSysEmployeeByBindUser", produces = MediaType.APPLICATION_JSON_VALUE)
    ResponseVO<PageVO<GetSysEmployeeByNoBindUserVO>> getSysEmployeeByBindUser(@RequestBody @Validated() GetSysEmployeeByNoBindUser getSysEmployeeByNoBindUser){
        return ResponseVO.success(sysEmployeeService.getSysEmployeeByBindUser(getSysEmployeeByNoBindUser));
    }
